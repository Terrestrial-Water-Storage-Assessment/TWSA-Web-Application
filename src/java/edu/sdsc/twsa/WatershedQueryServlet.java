 ...
 * @author kailin
 */
public class WatershedQueryServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Integer watershedId = obj.getInt("watershed_id");

        String sql
                = "SELECT watershed_id, day, cmwe, evaporation, precipitation, runoff \n"
                + "  FROM twsa_watershed_data \n"
                + " WHERE watershed_id = " + watershedId + " \n"
                + " ORDER BY day";
